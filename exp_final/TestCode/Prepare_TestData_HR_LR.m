...
path_original = 'E:/Userdata/shenhao/code/RCAN-pytorch/TestCode/OriginalTestData';
...
for idx_set = 1:length(dataset)
    ...
    for idx_im = 1:length(filepaths)
        ...
        for scale = scale_all
            ...
            folder_HR = fullfile('E:/Userdata/shenhao/code/RCAN-pytorch/TestCode/HR', dataset{idx_set}, ['x', num2str(scale)]);
            folder_LR = fullfile(['E:/Userdata/shenhao/code/RCAN-pytorch/TestCode/LR/LR', degradation], dataset{idx_set}, ['x', num2str(scale)]);
            ...
            % fn
            % fn_HR = fullfile('E:/Userdata/shenhao/code/RCAN-pytorch/TestCode/HR', dataset{idx_set}, ['x', num2str(scale)], [name_im(1:end-4), '_HR_x', num2str(scale), '.png']);
            fn_LR = fullfile(['E:/Userdata/shenhao/code/RCAN-pytorch/TestCode/LR/LR', degradation], dataset{idx_set}, ['x', num2str(scale)], [name_im(1:end-4), '_LR', degradation, '_x', num2str(scale), '.png']);
